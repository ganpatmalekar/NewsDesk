...
public class Culture extends Fragment {
    ...
    private static final String URL_GET_CULTURE = Constants.URL_EVERYTHING +
            "?q=culture&pageSize=100&language=en&sortBy=publishedAt&apiKey=" + Constants.NEWS_API_KEY;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.culture_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setHasFixedSize(true);

        refreshLayout = view.findViewById(R.id.culture_swipe_refresh_layout);
    ...
    private void displayCulture() {
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, URL_GET_CULTURE, null, new Response.Listener<JSONObject>() {
            @Override
