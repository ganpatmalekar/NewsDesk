...
public class Sports extends Fragment {
    ...
    private static final String URL_GET_SPORTS = Constants.URL_TOP_HEADLINES + "?country=in&category=sports&pageSize=100&apiKey=" + Constants.NEWS_API_KEY;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = view.findViewById(R.id.sports_swipe_refresh_layout);
    ...
    private void displaySports() {
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, URL_GET_SPORTS, null, new Response.Listener<JSONObject>() {
            @Override
