...
public class CrimeReport extends Fragment {
    ...
    private static final String URL_GET_CRIME_REPORT = Constants.URL_EVERYTHING +
            "?q=crime&pageSize=100&language=en&sortBy=publishedAt&apiKey=" + Constants.NEWS_API_KEY;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.crime_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setHasFixedSize(true);

        refreshLayout = view.findViewById(R.id.crime_swipe_refresh_layout);
    ...
    private void displayCrimeReport() {

        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, URL_GET_CRIME_REPORT, null, new Response.Listener<JSONObject>() {
            @Override
